...
const OPT = { OCC: ["Doctor", "Engineer", "Teacher", "Student", "Retired"], DEPT: ["General Medicine", "Surgery", "Cardiology", "Orthopedics", "Pediatrics", "Gynecology"], INS: ["None", "CGHS", "ESIC", "Private Insurance", "Other"], RATE: ["General", "Semi-Private", "Private", "Deluxe", "ICU", "ICCU", "Special Wards"], STATUS: ["Admitted", "Under Treatment", "Discharged"], GENDER: ["Female", "Male", "Other"], BLOOD: ["A+", "B+", "O+", "AB+"], SURGERY: ["No", "Yes"] };
  ...
  const ipdColumns = [
    ...
    { 
      ...
      cell: (row) => (
        <button
          className="cursor-pointer text-[var(--primary-color)] hover:text-[var(--accent-color)]"
          onClick={() => viewIpdPatientDetails(row)}
        >
          {row.name ||
    ...
    { 
      header: "Ward", 
      cell: (row) => [row.wardType, row.wardNo, row.bedNo].filter(Boolean).join("-")
    },
