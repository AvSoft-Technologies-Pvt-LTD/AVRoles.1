...
//             <motion.div whileHover={{ scale: 1.1 }} className="relative w-full h-full rounded-full overflow-hidden z-10 flex items-center justify-center">
//               <motion.img src={formData.imageUrl || "https://img.freepik.com/vecteurs-premium/icone-profil-avatar-par-defaut-image-utilisateur-medias-sociaux-icone-avatar-gris-silhouette-profil-vide-illustration-vectorielle_561158-3383.jpg?ga=GA1.1.1895928303.1746111458&semt=ais_hybrid&w=740"} alt="User Avatar" className="w-15 h-15 rounded-full object-cover border-2 border-[var(--accent-color)] shadow-md" initial={{ opacity: 0.9 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }} />
//             </motion.div>
